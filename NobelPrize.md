...
print(len(nobel[(nobel['year']<=2016) | (nobel['year']>1901)]))
...
sns.lmplot(data = nobel, y = 'age', x = 'year', lowess=True, aspect=2, line_kws={'color' : 'black'})
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7ff688d67630>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7ff688a18550>
